...
<body style="background-color: aliceblue;">
      ...
      <h3  style=" color:red;text-align: center;font-family:Lato;">Supprimer rendez-vous </h3>
  <div class="row">
    ...
    ?>
     ...
     <form method="post" action="delate.php" id="job-form">
              <label for="code">Pour supprimer  le rdv veuillez entrer le code rdv concerné :</label>
             <input type="text" id="id" name="code"  placeholder="code rdv">
       
             <input style="margin-left:6px" type="submit" value="supprimer le rdv"  id="submit">
             </form>
    </div> 
    <script ></script>
 </body>
