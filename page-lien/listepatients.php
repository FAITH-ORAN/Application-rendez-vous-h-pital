...
<body style="background-color: aliceblue;">
      ...
      <h3 class="title" style="text-align: center;font-family: 'Lato';color:green;">Liste des patients </h3>
  <div class="row">
    ...
    <tbody>
        ...
        try{
            ...
            $reponse = $connexion->query('SELECT * FROM patients ORDER BY firstname');
